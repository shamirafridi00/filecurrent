...
const sections = [
  ...
  { title: '4. Free Trial', content: 'New accounts receive a 5-day free trial with full access to all features. No credit card is required to begin the trial. When the trial ends, continued use requires an active paid subscription.' },
  { title: '5. Paid Plans', content: 'FileCurrent offers a monthly plan ($15/month) and an annual plan ($129/year). Both plans include every feature. Subscriptions automatically renew unless cancelled. Prices may change with 30 days advance notice to existing subscribers.' },
