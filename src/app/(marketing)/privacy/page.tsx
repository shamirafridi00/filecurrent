...
const sections = [
  ...
  {
    icon: <ShareNetwork className="h-5 w-5 text-teal-400" />,
  ...
  {
    icon: <CalendarBlank className="h-5 w-5 text-teal-400" />,
  ...
  {
    icon: <UserCircle className="h-5 w-5 text-teal-400" />,
    title: '6. Your Rights',
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {sections.map((section) => (
            <div key={section.title} className="border-b border-[#1a2a28] pb-8 last:border-0">
